...
- Twitter Link sharing rewards will be reduced, instead all users sharing and using iKPOP links will be rewarded no matter where they are posted. Each link will be an indyvidual referral link and each unique app open (not only new one) event will be generating benefits. 
- Follower reward reduced to 100
- 1,5x, 2x, 3x diamonds boosters activated for TOP users
